...
// import components
import ModelHeader from "../../admin/userManagement/ModelHeader";
...
export default function AdminModal({
    ...
    return (
        <div
            ...
            overflow-auto py-20"
        >
            <div className="bg-white w-full max-w-xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 mt-20">
                {/* model header */}
                <ModelHeader
                    isEditing={isEditing}
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-3 max-h-62.5 overflow-y-auto pr-2">
                    ...
                    <button
                        className="w-full py-4 rounded-2xl text-white font-bold text-sm tracking-wide transition-all cursor-pointer 
