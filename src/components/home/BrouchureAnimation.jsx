...
// brochure form animation component
export default function BrouchureAnimation() {
    return (
                ...
                <div className="grid grid-cols-3 gap-4 items-center">
                    ...
                    >
                        ...
                        <div className="text-center">
                            ...
                            <h5 className="text-[11px] font-bold text-slate-900 leading-tight">Core<br />Modules</h5>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="text-center z-10">
                            ...
                            <h5 className="text-xs font-black text-slate-900 mt-1">AI Integration</h5>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="text-center">
                            ...
                            <h5 className="text-[11px] font-bold text-slate-900 leading-tight">Shipped<br />Project</h5>
                        </div>
                    </motion.div>
                </div>
            </div>
