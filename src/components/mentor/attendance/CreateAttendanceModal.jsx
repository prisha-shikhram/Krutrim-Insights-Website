...
export default function CreateAttendanceModal({ onClose, batches, mentor, ATTENDANCE_API }) {
    ...
    const toggleStudentPresent = (email) => {
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                                    {allStudents.map(({ email, batchCode }) => {
                                        ...
                                        return (
                                            <div
                                                key={email}
                                                onClick={() => toggleStudentPresent(email)}
                                            ...
                                            >
                                                <div className="truncate pr-3">
                                                    <div className="flex items-center gap-2 mb-0.5">
                                                        ...
                                                        {isMarked && (
                                                            <span className="text-[9px] bg-slate-100 text-slate-600 border border-slate-200 px-1.5 py-0.2 rounded font-bold uppercase tracking-wider">
                                                                In DB
                                                            </span>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-[9px] font-bold text-indigo-500 bg-indigo-50 px-1.5 py-0.2 rounded border border-indigo-100 uppercase">
                                                            {batchCode}
                                                        </span>
                                                    </div>
                                                </div>
