    ...
    return (
        <div className="flex gap-4 mb-8">
            <div className="bg-white px-6 py-4 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-3">
                ...
                <div>
                    <p className="text-[10px] font-black uppercase text-slate-400">Pending Tasks</p>
                    <h4 className="text-lg font-black text-slate-800">{String(stats.pending).padStart(2, '0')}</h4>
                </div>
            </div>
