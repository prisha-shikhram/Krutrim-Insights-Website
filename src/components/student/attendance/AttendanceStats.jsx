            ...
            <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-black text-slate-800">{attendanceStats.percentage}%</h3>
                    </div>
                </div>
            ...
            <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-black text-slate-800">{attendanceStats.present} / {attendanceStats.totalClasses}</h3>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-black text-slate-800">{attendanceStats.absent} Days</h3>
                    </div>
                </div>
            </div>
        </div>
