// import suspense and outlet
import { Suspense } from "react";
import { Outlet } from "react-router-dom";

// student main component
export default function StudentMain({ getTitle, student, setStudent, handleImageUpload }) {
    return (
        <main className="flex-1 overflow-y-auto">
            ...
            <div className="px-10 pb-10">
                <Suspense fallback={
                    ...
                    {/* Passing student data down to all child modules */}
                    <Outlet
                        context={{
                            student,
                            setStudent,
