...
// import components
import MentorLogin from '../sections/Mentor/MentorLogin';
            ...
            <AnimatePresence mode="wait">
                {!isGateOpen ? (
                    ...
                    >
                        ...
                        <h2 className="text-3xl font-black text-slate-900 tracking-tight">System Gate</h2>
                        <p className="text-slate-500 text-sm mt-2 mb-10 font-medium">Verify your administrative identity to unlock the portal.</p>
