...
// import icons
import { Search, Mail, Phone, Calendar, ExternalLink, MessageSquare, UserCircle } from "lucide-react";
...
// brochure leads page
export default function BrochureLeads() {
    ...
    const API_URL = "https://23ft9h4js9.execute-api.ap-south-1.amazonaws.com/brochure";
    ...
    useEffect(() => {
        ...
        const fetchLeads = async () => {
            const tid = toast.loading("Syncing brochure leads...");
            ...
            try {
                ...
                toast.success("Brochure data updated", { id: tid });
            } catch (err) {
    ...
    const handleExportCSV = async () => {
        ...
        try {
            if (!isSuper) {
                recordLog(
                    "BROCHURE_DATA_EXPORT",
                    "Exported Brochure Leads CSV",
                    "security"
                );
            }
            ...
            a.href = url;
            a.download = `brochure_leads_${new Date().toISOString().split("T")[0]}.csv`;
            a.click();
    ...
    const handleContactClick = async (type, leadName, contactValue) => {
        ...
        // Brief toast for immediate feedback
        toast.success(
            `Redirecting to ${type === 'whatsapp' ? 'WhatsApp' : 'Mail'}...`,
            { id: "contact-action" }
        );
    };
                ...
                <div className="overflow-x-auto">
                                ...
                                >
                                    ...
                                    <td className="px-8 py-5 space-y-2">
                                        <div className="flex items-center gap-2 group/email">
                                            ...
                                            <span className="group-hover/email:text-[#0189c7] transition">
                                                {lead.email || "N/A"}
                                            </span>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-2 group/phone">
                                            ...
                                            <span className="group-hover/phone:text-green-600 transition">
                                                {lead.phone || "N/A"}
                                            </span>
                                        </div>
                                    </td>
                    ...
                    {!loading && filteredLeads.length === 0 && (
                        <div className="py-20 text-center">
                            ...
                            <p className="text-gray-400">No brochure requests found.</p>
                        </div>
                    )}
                </div>
            </div>
