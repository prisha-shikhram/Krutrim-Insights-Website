...
export default function Header({ PRIMARY }) {
    return (
        <div className="flex flex-col items-center mb-10">
            ...
            <h1 className="text-3xl font-extrabold tracking-tight text-gray-900">Registration Form</h1>
            <p className="text-gray-400 text-sm mt-2">Fill in your academic details to register</p>
        </div>
    );
}