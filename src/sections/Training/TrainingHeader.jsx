...
export default function TrainingHeader() {
    ...
    return (
        <section className="relative w-full min-h-[70vh] flex items-center justify-center px-6 overflow-hidden pt-20">
            {/* Gradient Background */}
            <Gradient />
            ...
            <div className="relative z-10 mx-auto max-w-5xl text-center py-10">
                ...
                <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl lg:text-7xl leading-[1.1]">
                    Beyond Theory.<br />
                    <span className="text-[#0189c7]">Project-Driven <br />
                ...
                <p className="text-lg md:text-xl font-medium text-gray-900 mb-10">
